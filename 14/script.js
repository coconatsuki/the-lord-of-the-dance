...
const finalMessages = [
  ...
  `Total score: {score}/60\n\nNot bad, Jimli! He managed to show a surprising amount of grace for a dwarf. His timing was a bit off, but he stayed in sync with Elowen, and his attempts at adding some dwarven flair brought a few smiles from the crowd. The judges nodded in approval, though they've definitely seen better.\n\nJimli might not take the top spot, but the dwarves back home will be proud of his showing, win or lose.\n\nCHECK THE CALENDAR TOMORROW TO SEE THE RESULT!`,
